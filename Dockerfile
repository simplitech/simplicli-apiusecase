...
RUN echo "export JAVA_OPTS=\"\$JAVA_OPTS -DENVIRONMENT=\$ENVIRONMENT -DDB_URL=\$DB_URL -DDB_NAME=\$DB_NAME -DDB_USER=\$DB_USER -DDB_PASS=\$DB_PASS\"" > $CATALINA_HOME/bin/setenv.sh
