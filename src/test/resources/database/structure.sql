...
CREATE TABLE IF NOT EXISTS `usecase`.`conectado` (
...
CREATE TABLE IF NOT EXISTS `usecase`.`conector_principal` (
...
CREATE TABLE IF NOT EXISTS `usecase`.`endereco` (
...
CREATE TABLE IF NOT EXISTS `usecase`.`extensao_do_principal` (
  `idPrincipalFk` int(11) NOT NULL,
  `titulo` varchar(45) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `usecase`.`grupo_do_principal` (
...
CREATE TABLE IF NOT EXISTS `usecase`.`item_do_principal` (
...
CREATE TABLE IF NOT EXISTS `usecase`.`principal` (
...
CREATE TABLE IF NOT EXISTS `usecase`.`tag` (
...
CREATE TABLE IF NOT EXISTS `usecase`.`tag_principal` (
  `idPrincipalFk` int(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `usecase`.`user` (
